...
public:
	...
	public:
		...
		const_iterator operator++(int) { const_iterator temp(*this); ++_i; return temp; }
		const_iterator& operator--() { --_i;  return *this; }
		const_iterator operator--(int) { const_iterator temp(*this); --_i; return temp; }
	...
	public:
		...
		{
			_da = other._da; _i = other._i;	return *this;
		}
		...
		T& operator*() { return _da->_arr[_i]; }
		T* operator->() { return &_da->_arr[_i]; }
		reverse_iterator& operator++() { --_i;	 return *this; } // returns by ref
		reverse_iterator operator++(int) { reverse_iterator temp(*this); --_i; return temp; } //returns cpy
	...
	// basic methoods
	iterator byIndex(int idx) { return iterator(*this, idx); }
	iterator append(int idx, const T& t) { _arr[idx] += t; return iterator(*this, idx); }
	iterator begin() { return iterator(*this, 0); }
	iterator end() { return iterator(*this, logSize); }
	const_iterator cbegin() const { return iterator(*this, 0); }
	const_iterator cend() const { return iterator(*this, logSize); }

	const_iterator begin() const { return const_iterator(*this, 0); }
	const_iterator end() const { return const_iterator(*this, logSize); }
	//const_iterator cbegin() const { return const_iterator(*this, 0); }
//	const_iterator cend() const { return const_iterator(*this, logSize); } // there is a ambiguity  with cbegin and crbegin and etc
	...
	reverse_iterator crend() const { return reverse_iterator(*this, logSize); }
